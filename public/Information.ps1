Function Get-iptHelp {
	<#
	.SYNOPSIS
	List commands available in the brshIPTools Module
	...
	$all = @()
	$list = Get-Command -Type function -Module "brshIPTools" | Where-Object { $_.Name -in $script:ShowHelp}
	$list | ForEach-Object {
