...
[string] $script:AppName = 'brshIPTools'
# Current script path
...
Get-ChildItem $ScriptPath/public -Recurse -Filter "*.ps1" -File | ForEach-Object {
	...
	([System.Management.Automation.Language.Parser]::ParseInput((Get-Content -Path $_.FullName -Raw), [ref] $null, [ref] $null)).FindAll( { $args[0] -is [System.Management.Automation.Language.FunctionDefinitionAst] }, $false) | ForEach-Object {
		# if (($IsLinux) -and ($_.Name -match 'Test-iptConnection')) {
...
#region Load Formats
if (Test-Path $ScriptPath\formats\brshIPTools.format.ps1xml) {
	Update-FormatData $ScriptPath\formats\brshIPTools.format.ps1xml
}
...
$ExecutionContext.SessionState.Module.OnRemove = {
	...
	Get-ChildItem alias: | Where-Object { $_.Source -match "brshIPTools" } | Remove-Item
	Get-ChildItem function: | Where-Object { $_.Source -match "brshIPTools" } | Remove-Item
	Get-ChildItem variable: | Where-Object { $_.Source -match "brshIPTools" } | Remove-Item
}
